$(document).ready(function () {
    ...
    const categoriesList = ["American", "Burger", "BBQ", "Diner", "Pizza", "Indian", "Mexican", "Italian", "Chinese", "Japanese", "Korean", "Thai", "Mediterranean", "Vegetarian", "Kosher", "Seafood", "Doughnuts"];
    let noResults = true;
